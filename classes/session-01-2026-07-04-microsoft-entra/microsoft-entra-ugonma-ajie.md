...
**Screenshot:** *(Insert Conditional Access policy screenshot)*

#### Task 2 – Configured Multi-Factor Authentication (MFA)
- Registered an authentication method using Microsoft Authenticator.
- Verified that MFA was required during sign-in.

**Screenshot:** *(Insert MFA registration/sign-in screenshot)*

#### Task 3 – Explored Privileged Identity Management (PIM)
...
**Screenshot:** *(Insert PIM screenshot)*
